...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/product?serverTimezone=UTC");
...
//        });
      ...
      templatePath = "/templates/controller.java.ftl";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                String expand = projectPath + "/com/asiainfo/billing/cloudproduct/" + "controller/impl";
 ...
 //业务层
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 + pc.getModuleName()
                String expand = projectPath + "/com/asiainfo/billing/cloudproduct/" + "service";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 + pc.getModuleName()
                String expand = projectPath + "/com/asiainfo/billing/cloudproduct/" + "service/impl";
...
*/
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 + pc.getModuleName()
                String expand = projectPath + "/com/asiainfo/billing/cloudproduct/"+"model";
...
//        templateConfig.setEntity("templates/1.java");
        ...
        //表名
        strategy.setInclude("product_info");
